...
class__t__lvl * class_t__function_b_1int_2bool__scene(const byte arrayOfByte[], boolean online)
{
	...
	i1 += 2;
	int i2 = marge_digit(arrayOfByte[i1], arrayOfByte[(i1 + 1)]);
	if (i2 != 0) {
		//eA = new short[i2];
	}
	int i5;
	...
	i1 += 2;
	int i6 = marge_digit(arrayOfByte[i1], arrayOfByte[(i1 + 1)]);
	...
	{
		i1 += 2;
		o[i7] = ((int)(65536 * marge_digit(arrayOfByte[i1], arrayOfByte[(i1 + 1)]) / 10000L));
		i1 += 2;
		o[(i7 + 1)] = ((int)(65536 * marge_digit(arrayOfByte[i1], arrayOfByte[(i1 + 1)]) / 10000L));
		i1 += 2;
		o[(i7 + 2)] = ((int)(65536 * marge_digit(arrayOfByte[i1], arrayOfByte[(i1 + 1)]) / 10000L));
	}
	...
	{
		i1 += 2;
		gg[i8] = ((int)(64 * marge_digit(arrayOfByte[i1], arrayOfByte[(i1 + 1)]) / 100L));
		i1 += 2;
		gg[(i8 + 1)] = ((int)(64 * marge_digit(arrayOfByte[i1], arrayOfByte[(i1 + 1)]) / 100L));
	}
	...
	for (i13 = 0; i13 < eU; i13++)
	{
		...
		i1 += 2;
		int i11 = marge_digit(arrayOfByte[i1], arrayOfByte[(i1 + 1)]);
		...
		{
			i1 += 2;
			a[(i14 * 3)] = ((short)marge_digit(arrayOfByte[i1], arrayOfByte[(i1 + 1)]));
			i1 += 2;
			a[(i14 * 3 + 1)] = ((short)marge_digit(arrayOfByte[i1], arrayOfByte[(i1 + 1)]));
			i1 += 2;
			a[(i14 * 3 + 2)] = ((short)marge_digit(arrayOfByte[i1], arrayOfByte[(i1 + 1)]));
		}
		...
		i1 += 2;
		int i18 = marge_digit(arrayOfByte[i1], arrayOfByte[(i1 + 1)]);
		...
		for (i20 = 0; i20 < i10; i20++)
		{
			i16 = i20 * 7;
			i1 += 2;
			b[(i16 + 3)] = ((short)marge_digit(arrayOfByte[i1], arrayOfByte[(i1 + 1)]) * 2);
			i1 += 2;
			b[(i16 + 4)] = ((short)marge_digit(arrayOfByte[i1], arrayOfByte[(i1 + 1)]) * 2);
			i1 += 2;
			b[(i16 + 5)] = ((short)marge_digit(arrayOfByte[i1], arrayOfByte[(i1 + 1)]) * 2);
		}
		...
		{
			i1++;
			int i22 = marge_digit(arrayOfByte[i1], arrayOfByte[(i1 + 1)]);
			if (i22 < 0) {
				i22 += 256;
			}
	...
	i1 += 2;
	int i12 = marge_digit(arrayOfByte[i1], arrayOfByte[(i1 + 1)]);
	...
	for (i15 = 0; i15 < i12; i15++)
	{
		...
		i1 += 2;
		int i3 = (int)(65536 * marge_digit(arrayOfByte[i1], arrayOfByte[(i1 + 1)]) / 10000L);
		i1 += 2;
		int i4 = (int)(65536 * marge_digit(arrayOfByte[i1], arrayOfByte[(i1 + 1)]) / 10000L);
		i1 += 2;
	...
	for (i22 = 0; i22 < eU; i22++)
	{
		...
		for (i23 = 0; i23 < i20; i23++)
		{
			...
			//cJ[q[i21].t] = true;
			i1 += 2;
			q[i21].e = ((short)marge_digit(arrayOfByte[i1], arrayOfByte[(i1 + 1)]));
			if (q[i21].e < 0)
			{
	...
	i1 += 2;
	int i25 = (byte)marge_digit(arrayOfByte[i1], arrayOfByte[(i1 + 1)]);
	//cy = i25;
	//cz = new short[i25 * 3];
	int i28;
	...
	//eN = null;
	i1 += 2;
	int i29 = marge_digit(arrayOfByte[i1], arrayOfByte[(i1 + 1)]);
#if UNPARSED
	if (i29 != 0) {
		eN = new short[i29];
	} else {
	...
	int i31 = marge_digit(arrayOfByte[i1], arrayOfByte[(i1 + 1)]);
#if UNPARSED
	if (i31 != 0) {
...
void class_t__function_av_void__item(class__i__item *p, const byte arrayOfByte1[])
{
	...
	i1 += 2;
	i1 += 2;
	int i9 = marge_digit(arrayOfByte1[i1], arrayOfByte1[(i1 + 1)]);
	i1 += 2;
	int i8 = marge_digit(arrayOfByte1[i1], arrayOfByte1[(i1 + 1)]);
	i1 += 2;
	...
	{
		i1 += 2;
		b[(i14 * 16 + 10)] = ((int)(65536 * marge_digit(arrayOfByte1[i1], arrayOfByte1[(i1 + 1)]) / 10000L));
		i1 += 2;
		b[(i14 * 16 + 11)] = ((int)(65536 * marge_digit(arrayOfByte1[i1], arrayOfByte1[(i1 + 1)]) / 10000L));
		i1 += 2;
		b[(i14 * 16 + 12)] = ((int)(65536 * marge_digit(arrayOfByte1[i1], arrayOfByte1[(i1 + 1)]) / 10000L));
	}
	int i15;
	for (i15 = 0; i15 < i10; i15 += 2)
	{
		i1 += 2;
		arrayOfInt[i15] = ((int)(64 * marge_digit(arrayOfByte1[i1], arrayOfByte1[(i1 + 1)]) / 100L));
		i1 += 2;
		arrayOfInt[(i15 + 1)] = ((int)(64 * marge_digit(arrayOfByte1[i1], arrayOfByte1[(i1 + 1)]) / 100L));
	}
	int i16;
	for (i16 = 0; i16 < i8; i16++)
	{
		i1 += 2;
		b[(i16 * 16 + 3)] = ((short)arrayOfInt[(marge_digit(arrayOfByte1[i1], arrayOfByte1[(i1 + 1)]) * 2)]);
		b[(i16 * 16 + 4)] = ((short)arrayOfInt[(marge_digit(arrayOfByte1[i1], arrayOfByte1[(i1 + 1)]) * 2 + 1)]);
		i1 += 2;
		b[(i16 * 16 + 5)] = ((short)arrayOfInt[(marge_digit(arrayOfByte1[i1], arrayOfByte1[(i1 + 1)]) * 2)]);
		b[(i16 * 16 + 6)] = ((short)arrayOfInt[(marge_digit(arrayOfByte1[i1], arrayOfByte1[(i1 + 1)]) * 2 + 1)]);
		i1 += 2;
		b[(i16 * 16 + 7)] = ((short)arrayOfInt[(marge_digit(arrayOfByte1[i1], arrayOfByte1[(i1 + 1)]) * 2)]);
		b[(i16 * 16 + 8)] = ((short)arrayOfInt[(marge_digit(arrayOfByte1[i1], arrayOfByte1[(i1 + 1)]) * 2 + 1)]);
	}
	i1 += 2;
	int i17;
