...
int ray_line_to_plane_intersect(const ray_t *line, const plane_t *plane, vector3_t *point)
{
...
int ray_line_to_plane_collision(const ray_t *line, const plane_t *plane, float *lamda, vector3_t *normal)
{
...
void line_ray_to_line(line_t *r, const ray_t *a, float length)
{
    ...
    vector3_t normal = RAYV_DIRECTION(a);
