...
int push_from_qvariant(struct lua_State* L, const QVariant &value);
int push_from_qvarianti(struct lua_State* L, const QVariant &value, int type);
int push_from_qvariants(struct lua_State* L, const QVariant &value, int typeindex);
int push_from_qvariants(struct lua_State* L, const QVariant &value, const QString &type);
