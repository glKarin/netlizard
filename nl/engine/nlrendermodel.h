...
template <class T>
struct NLLIB_EXPORT NLRenderModelVertexItem
{
...
template <class T>
class NLLIB_EXPORT NLRenderModelData
{
public:
...
template <class T>
class NLLIB_EXPORT NLRenderModelVertex : public NLRenderModelData<T>
{
public:
...
class NLLIB_EXPORT NLRenderModelPrimitive
{
public:
...
class NLLIB_EXPORT NLRenderModel
{
public:
...
class NLLIB_EXPORT NLRenderModelGL : public NLRenderModel<VertexT, IndexT, GLint, GLenum>
{
public:
...
NLRenderModelData<T>::~NLRenderModelData()
{
    NLDEBUG_DESTROY("NLRenderModelData<T>")
}
...
NLRenderModelVertex<T>::~NLRenderModelVertex()
{
    NLDEBUG_DESTROY("NLRenderModelVertex<T>")
}
...
NLRenderModelPrimitive<T, TextureT, ModeT>::~NLRenderModelPrimitive()
{
    NLDEBUG_DESTROY("NLRenderModelPrimitive<T, TextureT, ModeT>")
}
