...
NLMATHLIB_EXPORT void frustum_make(frustum_t *bo, float left, float right, float bottom, float top, float z_near, float z_far);
NLMATHLIB_EXPORT void frustum_matrix(const frustum_t *bo, GLmatrix *mat);

NLMATHLIB_EXPORT void perspective_make(perspective_t *bo, float fovy, float aspect, float z_near, float z_far);
NLMATHLIB_EXPORT void perspective_make_with_wh(perspective_t *bo, float fovy, float width, float height, float z_near, float z_far);
NLMATHLIB_EXPORT void perspective_matrix(const perspective_t *bo, GLmatrix *mat);
