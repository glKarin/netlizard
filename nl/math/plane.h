...
NLMATHLIB_EXPORT void plane_make(plane_t *plane, const vector3_t *pos, const vector3_t *nor);
NLMATHLIB_EXPORT float plane_point_to_plane_distance(const plane_t *plane, const vector3_t *point);
NLMATHLIB_EXPORT float plane_d(const plane_t *plane);
NLMATHLIB_EXPORT int plane_equals(const plane_t *plane, const plane_t *o);

NLMATHLIB_EXPORT int plane_ray_intersect(const plane_t *plane, const struct ray_s *line, float *lamda, vector3_t *point, float *scale);
NLMATHLIB_EXPORT void plane_triangle_plane(plane_t *plane, const struct triangle_s *tri);
NLMATHLIB_EXPORT int plane_point_clip(const plane_t *plane, const vector3_t *v);
NLMATHLIB_EXPORT int plane_point_clip_precision(const plane_t *plane, const vector3_t *v, float precision);

NLMATHLIB_EXPORT int plane_line_intersect(const plane_t *plane, const struct line_s *line, float *lamda, vector3_t *point, int *dir, int *mask);
