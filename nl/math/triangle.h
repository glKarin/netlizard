...
NLMATHLIB_EXPORT void triangle_make(triangle_t *tri, const vector3_t *a, const vector3_t *b, const vector3_t *c);
NLMATHLIB_EXPORT void triangle_cale_normal(const triangle_t *tri, vector3_t *normal);
NLMATHLIB_EXPORT void triangle_center_point(const triangle_t *tri, vector3_t *p);
