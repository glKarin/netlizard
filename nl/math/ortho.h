...
NLMATHLIB_EXPORT void ortho_make(ortho_t *bo, float left, float right, float bottom, float top, float z_near, float z_far);
NLMATHLIB_EXPORT void ortho_make2d(ortho_t *bo, float left, float right, float bottom, float top);
NLMATHLIB_EXPORT void ortho_matrix(const ortho_t *bo, GLmatrix *mat);
NLMATHLIB_EXPORT void ortho_matrix2d(const ortho_t *bo, GLmatrix *mat);
NLMATHLIB_EXPORT void ortho_min(const ortho_t *bo, struct vector3_s *m);
NLMATHLIB_EXPORT void ortho_max(const ortho_t *bo, struct vector3_s *m);
